...
| Bed thermal feedback | closed-loop feedback + arrival timing | blocked by the prime — and note it reads the Pod's **water-side level**, not a thermometer (see below) |
